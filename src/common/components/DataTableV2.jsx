                ...
                <thead className={`${hideHeaderOnMobile ? "laptop:contents tablet:hidden max-sm:hidden " : ""}`}>
                    <tr className="border-b-2 border-black/40 w-full text-left">
                        {(keys ?? []).map((ii, index) => {
                            ...
                            if (ii?.render) return <th key={index} className={`font-semibold max-w-[${ii?.col}] px-2 py-2 text-sm font-medium text-black/40 uppercase`}>
                                {ii?.render}
                            </th>;
                            ...
                            // </div>
                            return (
                                <th key={index} className={`font-semibold max-w-[${ii?.col}] px-2 py-2 text-sm font-medium text-black/40 uppercase`}>
                                    {ii?.label ?? ii?.key}
                                </th>
                            )
                        })}
