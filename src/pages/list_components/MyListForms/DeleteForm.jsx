...
const DeleteForm = ({ editList, setShowModal }) => {
    ...
    return (
        <form ref={formRef} onSubmit={submitEditForm} className='flex-inline'>
            ...
            <div className='mt-5'>
                ...
                <div className='mt-5'>
                    <p className='text-sm'>Are you sure you want to delete list “{editList?.name}”? This cannot</p>
                    <p className='text-sm'>be undone and you will not be able to recover your list.</p>
                </div>
            </div>
            <div className='mt-5 '>
                <div>
                    <button type='submit' className='btn bg-blue p-2 border rounded-md text-white py-2 px-10'>Delete</button>
                </div>
                <div className='mt-3'>
                    <button type='button' className='btn bg-transparent text-blue px-10' onClick={() => setShowModal(false)}>Cancel</button>
                </div>
            </div>
        </form>
    )
